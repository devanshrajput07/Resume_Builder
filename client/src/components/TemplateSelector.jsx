...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
  ...
  const templates = [
    ...
    },
    {
      ...
      name: "Modern",
      preview:
        "Sleek design with strategic use of color and contemporary fonts.",
    },
    {
      id: "minimal",
      name: "Minimal",
      preview: "Ultra clean design that puts your content in the spotlight.",
    },
    {
      id: "minimal-image",
      name: "Minimal-Image",
      preview: "A minimal template with a single image and clean typography.",
    },
  ];
  return (
